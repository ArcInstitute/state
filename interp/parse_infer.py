...
MODEL_DIR = Path(
    ...
    "/large_storage/ctc/userspace/aadduri/preprint_parse/parse_donor_tahoe_best_cs512_2000_state_pretrained/parse_donor_state_2000"
...
CONTROL_SAMPLES = 50 
LAYER_IDX = 3
FIG_DIR = Path(__file__).resolve().parent / "figures" / "parse_infer" 
FIG_DIR.mkdir(parents=True, exist_ok=True)

checkpoint_path = MODEL_DIR / "checkpoints" / "step=136000.ckpt"
...
cells_type1 = adata_full[(adata_full.obs["cytokine"] == control_pert) & 
